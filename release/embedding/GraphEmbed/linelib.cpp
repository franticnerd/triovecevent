...
void line_node::init(char *file_name, int vector_dim, char *job_id)
{
    strcat(file_name,job_id);
...
void line_node::output(char *file_name, int binary, int context, char *job_id)
{
    strcat(file_name,job_id);
...
void line_hin::init(char *file_name, line_node *p_u, line_node *p_v, char *job_id)
{
    strcat(file_name,job_id);
